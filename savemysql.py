...
if __name__ == "__main__":
    # 例如：输入2 则为 "abucya-xsddaz",输入3 则为"dwedd-xscc-csddcd”
    group=int(input("input number consist of each activate-code:"))
    # 想要创建的激活码数目
    number=int(input("input generate's number and insert into database directly:"))
